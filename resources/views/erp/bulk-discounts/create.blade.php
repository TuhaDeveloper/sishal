...
@section('title', 'Create Bulk Discount')
...
@include('erp.components.sidebar')
    ...
    @include('erp.components.header')
                ...
                <div class="col-md-8">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-2">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Create Bulk Discount</li>
                        </ol>
                    </nav>
                    <h2 class="fw-bold mb-0">Create Bulk Discount</h2>
                    <p class="text-muted mb-0">Apply a percentage discount to all products or specific products.</p>
                </div>
        ...
        <div class="container-fluid px-4 py-4">
            ...
            <form action="{{ route('bulk-discounts.store') }}" method="POST" id="bulkDiscountForm">
                @csrf
                <div class="row">
                    <div class="col-lg-8">
                        <!-- Basic Information -->
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror" 
                                              ...
                                              placeholder="Enter discount description...">{{ old('description') }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('scope_type') is-invalid @enderror" id="scope_type" name="scope_type" required>
                                        <option value="all" {{ old('scope_type', 'all') == 'all' ? 'selected' : '' }}>All Products</option>
                                        <option value="products" {{ old('scope_type') == 'products' ? 'selected' : '' }}>Specific Products</option>
                                    </select>
                                    @error('scope_type')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
