                ...
                <div class="col-md-8">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-3">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route('saleReturn.list') }}" class="text-decoration-none text-primary">
                                    <i class="fas fa-undo me-1"></i>Sale Returns
                                </a>
                            </li>
                            <li class="breadcrumb-item active" aria-current="page">Return #{{ $saleReturn->id }}</li>
                        </ol>
                    </nav>
                    <div class="d-flex align-items-center mb-2">
                        <h1 class="fw-bold mb-0 me-3">Sale Return #{{ $saleReturn->id }}</h1>
                        <div class="status-indicator">
                            @switch($saleReturn->status)
                                ...
                                @case('processed')
                                    ...
                                    @break
                                @default
                                    <span class="badge bg-secondary fs-6 px-3 py-2">{{ ucfirst($saleReturn->status) }}</span>
                            @endswitch
                        </div>
                    </div>
                        ...
                        <div class="card-body p-4">
                            <div class="row g-4">
                                <div class="col-md-6">
                                    <div class="info-item mb-4">
                                        ...
                                        <p class="mb-0 fw-bold fs-5 text-dark">#{{ $saleReturn->id }}</p>
                                    </div>
                                    ...
                                    <div class="info-item mb-4">
                                        ...
                                        <p class="mb-0 fw-bold fs-5 text-dark">{{ $saleReturn->customer->name ?? 'N/A' }}</p>
                                    </div>
                                    ...
                                    <div class="info-item mb-4">
                                        ...
                                        <p class="mb-0 fw-bold fs-5 text-dark">{{ $saleReturn->return_date }}</p>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="info-item mb-4">
                                        ...
                                        <p class="mb-0 fw-bold fs-5 text-dark">{{ ucfirst($saleReturn->refund_type) }}</p>
                                    </div>
                                    ...
                                    <div class="info-item mb-4">
                                        ...
                                        <p class="mb-0 fw-bold fs-5 text-dark">
                                            ...
                                            @if($saleReturn->return_to_type === 'branch' && $saleReturn->return_to_id)
                                                {{ optional($saleReturn->branch)->name ?? 'N/A' }}
                                            @elseif($saleReturn->return_to_type === 'warehouse' && $saleReturn->return_to_id)
                                                {{ optional($saleReturn->warehouse)->name ?? 'N/A' }}
                                            @elseif($saleReturn->return_to_type === 'employee' && $saleReturn->employee)
                                                {{ $saleReturn->employee->user->first_name ?? '' }} {{ $saleReturn->employee->user->last_name ?? '' }}
                                            @else
                                                N/A
                                            @endif
                                        </p>
                            ...
                            <div class="mb-4 mt-4">
                                ...
                                <div class="bg-light border-start border-4 border-warning p-3 rounded-end">
                                    <p class="mb-0 fs-6">{{ $saleReturn->reason }}</p>
                                </div>
                            </div>
                            @endif
                            ...
                            <div class="mb-4">
                                ...
                                <div class="bg-light border-start border-4 border-info p-3 rounded-end">
                                    <pre class="mb-0 text-dark fs-6 font-monospace">{{ $saleReturn->notes }}</pre>
                                </div>
                            </div>
                            @endif
                        </div>
                        ...
                        <div class="card-header bg-gradient-success text-white border-0 py-4">
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <span class="badge bg-white text-success fs-6 px-3 py-2">
                                    {{ $saleReturn->items->count() }} {{ Str::plural('Item', $saleReturn->items->count()) }}
                                </span>
                            </div>
                        </div>
                    ...
                    <div class="card border-0 shadow-sm mb-4">
                        ...
                        <div class="card-body p-4">
                            <div class="row text-center">
                                <div class="col-6">
                                    <div class="summary-item">
                                        ...
                                        <h3 class="fw-bold mb-1">{{ $saleReturn->items->count() }}</h3>
                                ...
                                <div class="col-6">
                                    <div class="summary-item">
                                        ...
                                        <h3 class="fw-bold mb-1">{{ number_format($saleReturn->items->sum('total_price'), 2) }}৳</h3>
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <span class="fw-bold">{{ $saleReturn->return_date }}</span>
                            </div>
                            <div class="d-flex justify-content-between align-items-center mt-2">
                                <span class="text-muted">Current Status:</span>
                                <span class="fw-bold">{{ ucfirst($saleReturn->status) }}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card border-0 shadow-sm">
                        ...
                        <div class="card-body p-4">
                            <div class="d-grid gap-2">
                                <a href="{{ route('saleReturn.edit', $saleReturn->id) }}" class="btn btn-outline-primary btn-lg">
                                ...
                                <hr class="my-3">
                                <form action="{{ route('saleReturn.delete', $saleReturn->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
